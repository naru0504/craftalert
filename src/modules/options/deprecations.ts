/*
 * A list of all the deprecated options from craftalert 1.X
...
export const logDeprecation = (name: string): void => {
  ...
  let message = `craftalert warning: "${name}" option has been ${destiny}.`;
  ...
  const DOMAIN = 'https://craftalert.js.org';
